...
class FCompiler(CCompiler):
    ...
    def link(self, target_desc, objects, output_filename, output_dir: Optional[Any] = ..., libraries: Optional[Any] = ..., library_dirs: Optional[Any] = ..., runtime_library_dirs: Optional[Any] = ..., export_symbols: Optional[Any] = ..., debug=..., extra_preargs: Optional[Any] = ..., extra_postargs: Optional[Any] = ..., build_temp: Optional[Any] = ..., target_lang: Optional[Any] = ...):
        ...
...
_default_compilers = (('win32', ('gnu', 'intelv', 'absoft', 'compaqv', 'intelev', 'gnu95', 'g95', 'intelvem', 'intelem', 'flang')), ('cygwin.*', ('gnu', 'intelv', 'absoft', 'compaqv', 'intelev', 'gnu95', 'g95')), ('linux.*', ('gnu95', 'intel', 'lahey', 'pg', 'absoft', 'nag', 'vast', 'compaq', 'intele', 'intelem', 'gnu', 'g95', 'pathf95', 'nagfor')), ('darwin.*', ('gnu95', 'nag', 'absoft', 'ibm', 'intel', 'gnu', 'g95', 'pg')), ('sunos.*', ('sun', 'gnu', 'gnu95', 'g95')), ('irix.*', ('mips', 'gnu', 'gnu95')), ('aix.*', ('ibm', 'gnu', 'gnu95')), ('posix', ('gnu', 'gnu95')), ('nt', ('gnu', 'gnu95')), ('mac', ('gnu95', 'gnu', 'pg')))
...
def _find_existing_fcompiler(compiler_types, osname: Optional[Any] = ..., platform: Optional[Any] = ..., requiref90: bool = ..., c_compiler: Optional[Any] = ...):
    ...

def available_fcompilers_for_platform(osname: Optional[Any] = ..., platform: Optional[Any] = ...):
    ...

def get_default_fcompiler(osname: Optional[Any] = ..., platform: Optional[Any] = ..., requiref90: bool = ..., c_compiler: Optional[Any] = ...):
    """Determine the default Fortran compiler to use for the given
    platform."""
    ...

failed_fcompilers = set()
def new_fcompiler(plat: Optional[Any] = ..., compiler: Optional[Any] = ..., verbose=..., dry_run=..., force=..., requiref90: bool = ..., c_compiler: Optional[Any] = ...):
