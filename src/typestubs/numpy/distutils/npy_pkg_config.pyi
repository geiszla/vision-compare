...
class LibraryInfo(object):
    ...
    """
    def __init__(self, name, description, version, sections, vars, requires: Optional[Any] = ...):
        self.name = ...
        self.description = ...
        self.version = ...
        self.vars = ...
...
def parse_config(filename, dirs: Optional[Any] = ...):
    ...

def _read_config_imp(filenames, dirs: Optional[Any] = ...):
    ...
