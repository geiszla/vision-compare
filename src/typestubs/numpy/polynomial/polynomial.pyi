...
def polypow(c, pow, maxpower: Optional[Any] = ...):
...
def polyvalfromroots(x, r, tensor: bool = ...):
    """
...
def polyfit(x, y, deg, rcond: Optional[Any] = ..., full: bool = ..., w: Optional[Any] = ...):
    """
