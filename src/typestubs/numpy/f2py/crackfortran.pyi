...
def get_useparameters(block, param_map: Optional[Any] = ...):
    ...

def postcrack2(block, tab=..., param_map: Optional[Any] = ...):
    ...

def postcrack(block, args: Optional[Any] = ..., tab=...):
    """
    TODO:
...
def myeval(e, g: Optional[Any] = ..., l: Optional[Any] = ...):
    ...
...
def _selected_real_kind_func(p, r=..., radix=...):
    ...
...
def crack2fortrangen(block, tab=..., as_interface: bool = ...):
    ...
...
def vars2fortran(block, vars, args, tab=..., as_interface: bool = ...):
    """
    TODO:
    public sub
    ...
