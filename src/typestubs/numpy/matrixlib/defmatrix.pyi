...
@set_module('numpy')
def asmatrix(data, dtype: Optional[Any] = ...):
    """
...
class matrix(N.ndarray):
    ...
    """
    __array_priority__ = ...
    def __new__(subtype, data, dtype: Optional[Any] = ..., copy: bool = ...):
        ...
    ...
    def std(self, axis: Optional[Any] = ..., dtype: Optional[Any] = ..., out: Optional[Any] = ..., ddof=...):
        """
    ...
    def var(self, axis: Optional[Any] = ..., dtype: Optional[Any] = ..., out: Optional[Any] = ..., ddof=...):
        """
...
@set_module('numpy')
def bmat(obj, ldict: Optional[Any] = ..., gdict: Optional[Any] = ...):
    """
