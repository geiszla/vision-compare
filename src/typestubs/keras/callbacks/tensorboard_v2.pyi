...
class TensorBoard(tf.keras.callbacks.TensorBoard):
    ...
    """
    def __init__(self, log_dir=..., histogram_freq=..., batch_size: Optional[Any] = ..., write_graph: bool = ..., write_grads: bool = ..., write_images: bool = ..., embeddings_freq=..., embeddings_layer_names: Optional[Any] = ..., embeddings_metadata: Optional[Any] = ..., embeddings_data: Optional[Any] = ..., update_freq=..., **kwargs):
        ...
