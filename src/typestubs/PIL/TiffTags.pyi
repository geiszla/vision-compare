...
class TagInfo(namedtuple("_TagInfo", "value name type length enum")):
    __slots__ = ...
    def __new__(cls, value: Optional[Any] = ..., name=..., type: Optional[Any] = ..., length: Optional[Any] = ..., enum: Optional[Any] = ...):
        ...
